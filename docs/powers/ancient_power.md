...
<img src="/images/powers/ancient_power.png" alt="远古" style="max-width:300px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.15)" />
...
远古属性。克制草、飞行、神秘、龙、虚空。对机械、冰、王、轮回微弱。
