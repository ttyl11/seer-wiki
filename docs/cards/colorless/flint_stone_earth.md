...
- **削的是你自己的攻击伤害——攻击流慎用**：减伤方向是**你造成的**攻击伤害：每有 <span style="color:#3aa675;font-weight:600">2</span> 点当前[格挡](/mechanics/block.md)，你的攻击伤害 -<span style="color:#3aa675;font-weight:600">1</span>。格挡攒到 20 时每次攻击 -10——出牌越多防御越厚、拳头越软，这是刻意的攻防交换设计，**不是防御增益的全家桶**。
