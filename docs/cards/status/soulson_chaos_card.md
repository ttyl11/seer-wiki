...
- **⚠️ 与"混沌化身"的死亡连招**：索伦森开局给你施加的[混沌化身](/powers/soulson_chaos_incarnation_power.md)允许你在能量不足时打牌、超额部分扣最大生命。混沌迭印叠高 → 双倍消耗多层 → 费用暴增 → 频繁触发"能量不足" → 最大生命被当燃料烧。混沌层数越高，这套组合越致命——冻结混沌牌、及时驱散双倍消耗，是在切断这条连招链。
