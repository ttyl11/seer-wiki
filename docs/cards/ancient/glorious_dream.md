...
- **目标**: 无
- **可升级**: 是（1 级）
- **对应初始牌**: [生命](/cards/basic/life.md)（由[起源流转](/relics/starter/origin_shift.md)转化）
...
- **主动制造被克制**：配合能改变自身元素属性的卡牌（如[元素](/cards/basic/element.md)）使用，开局先看清敌方元素再切到被克制的属性，1 费吃到全属性 +2 + 20 回血的满额收益，还顺带吃"被克制但反正要打持久战"的局面。
