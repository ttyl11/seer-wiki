...
- **配合力量加成**：每次命中是独立攻击伤害，[力量](/powers/strength_power.md)每层让每次命中 +1 伤。X=2 配 3 层力量 = 14×(1+3) = 56 伤，多段卡牌配合力量收益翻倍。
- **单次 1 伤怕格挡**：每次命中只 <span style="color:#3aa675;font-weight:600">1</span> 点攻击伤害，敌人有格挡时单次会被完全抵消。适合对无格挡或格挡已耗尽的敌人使用。
