...
- **25 种异常状态随机**：从 <span style="color:#3aa675;font-weight:600">25</span> 种异常状态中随机选取 2 种施加——包括[睡眠](/powers/sleep_power.md)、[凝滞](/powers/stasis_power.md)、[冰封](/powers/freeze_power.md)、[失明](/powers/blind_power.md)、[臣服](/powers/subjugation_power.md)、[狂暴](/powers/fury_power.md)等强力控制，也包括[中毒](/powers/poison_power.md)、[烧伤](/powers/burn_power.md)等持续伤害。随机性既是优势（不可预测、防不胜防）也是劣势（可能抽到对当前敌人无效的状态）。
