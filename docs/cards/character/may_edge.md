...
- **暴击机制不需要这张牌提供**：暴击是角色的默认机制——每回合开始自动为场上所有生物刷新暴击能力，<span style="color:#3aa675;font-weight:600">12.5%</span> 概率全程在线。这张牌只负责"暴击时追加先制奖励"，本身不改变暴击率。
...
- **暴击率决定收益上限**：这张牌的价值完全取决于暴击率。<span style="color:#3aa675;font-weight:600">12.5%</span> 基础暴击率意味着平均每 <span style="color:#3aa675;font-weight:600">8</span> 次攻击才触发一次先制——配合把暴击率改为 <span style="color:#3aa675;font-weight:600">50%</span> 的[锁定I](/powers/lock_one_power.md)、必定暴击的[锁定II](/powers/lock_two_power.md)或[必定暴击](/powers/next_guaranteed_crit_power.md)类效果时，几乎每次攻击都能白拿先制，正循环全速运转。
