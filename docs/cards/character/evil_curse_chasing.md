...
- **跟踪+虚弱联动（核心机制）**：[跟踪](/powers/tracking_power.md)是原版能力——拥有者对带有[虚弱](/powers/weak_power.md)的敌人造成**攻击伤害**时，伤害 × 跟踪层数（2 层 = ×2）。此牌获得 2 层跟踪 + 为所有敌人附加 2 层虚弱——打出后**你对所有敌人的攻击伤害 ×2**，是群体爆发的前提。注意只对攻击伤害生效，非攻击伤害不受跟踪加成。
