...
<img src="/images/cards/magic_element_bubble.png" alt="魔法元素泡" style="max-width:300px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.15)" />
...
PP: <span style="color:#3aa675;font-weight:600">1</span>/<span style="color:#3aa675;font-weight:600">1</span> 获得<span style="color:#3aa675;font-weight:600">1</span>层[<span style="color:#d4a017;font-weight:600">集中</span>](/powers/focus_power.md)。随机<span style="color:#3aa675;font-weight:600">生成</span><span style="color:#3aa675;font-weight:600">2</span>个赛尔[<span style="color:#d4a017;font-weight:600">充能球</span>](/mechanics/orb.md)。

## 升级后

PP: <span style="color:#3aa675;font-weight:600">1</span>/<span style="color:#3aa675;font-weight:600">1</span> 获得<span style="color:#3aa675;font-weight:600">1</span>层[<span style="color:#d4a017;font-weight:600">集中</span>](/powers/focus_power.md)。随机<span style="color:#3aa675;font-weight:600">生成</span><span style="color:#3aa675;font-weight:600">3</span>个赛尔[<span style="color:#d4a017;font-weight:600">充能球</span>](/mechanics/orb.md)。
...
- [集中](/powers/focus_power.md)：增益，提升充能球触发效果

## 源码

- `SeerMagicElementBubble.cs`
