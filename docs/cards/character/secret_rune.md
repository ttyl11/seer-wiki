...
- **降级不回退累加——已积累的恢复量保留**：若这张牌被某些机制降级，已累加的恢复量会保留，只有每次累加量从 +5 回退到 +2。所以"升过级又被打回基础版"不会让投资打了水漂，只是后续每次累加变慢。
- **烧伤是群体效果**：对所有可命中敌人挂 2 回合烧伤——烧伤每回合造成 3 点不可格挡的非攻击伤害并使敌方攻击伤害 -1，配合火山充能球的被动可形成持续火焰压制。
- **性价比**：1 费合理——三合一效果 + 复利成长性，前期投资后期回报。
