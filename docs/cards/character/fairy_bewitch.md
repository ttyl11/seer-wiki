...
PP: <span style="color:#3aa675;font-weight:600">1</span>/<span style="color:#3aa675;font-weight:600">1</span> 对手每有一种<span style="color:#d4a017;font-weight:600">增益</span>耗能<span style="color:#3aa675;font-weight:600">+1</span>。为所有对手附加[<span style="color:#d4a017;font-weight:600">魅惑</span>](/powers/bewitch_power.md)。

## 升级后

[<span style="color:#d4a017;font-weight:600">保留</span>](/mechanics/retain.md)。PP: <span style="color:#3aa675;font-weight:600">1</span>/<span style="color:#3aa675;font-weight:600">1</span> 对手每有一种<span style="color:#d4a017;font-weight:600">增益</span>耗能<span style="color:#3aa675;font-weight:600">+1</span>。为所有对手附加[<span style="color:#d4a017;font-weight:600">魅惑</span>](/powers/bewitch_power.md)。

## 小贴士

- **能力牌常驻**：打出后对所有敌人施加[魅惑](/powers/bewitch_power.md)，常驻整场战斗。受魅惑者每次回合开始时判定一次——身上每种可见增益提供 10% 眩晕概率，5 种增益 = 50% 跳过回合，10 种 = 必定跳过。
