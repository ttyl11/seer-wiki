...
- **双轴加成要分清**：主伤害按"消耗堆牌数"线性放大，附加的[固定伤害](/powers/fixed_damage_power.md)则按"你所有 PP 牌累计已消耗的 PP 总值"计算（每张 PP 牌贡献 最大PP − 当前PP，本牌自己打出的这次也先扣 1 PP、计入其中）。两个轴互相独立——你可以靠大量低 PP 消耗牌堆牌数，也可以靠几张高 PP 牌烧 PP 撑固伤，最理想是两者都堆起来。
- **固伤是回合开始才结算的延迟伤害**：附加的固定伤害以减益形式挂在每个敌人身上，**到敌人自己回合开始时才扣血**（之后移除）。这意味着它不能当回合补刀，但好处是**无视格挡、无视攻击伤害减免**，对叠甲/减伤型 Boss 极其有效。注意两类反制：敌人若有[免疫固定伤害](/powers/immune_fixed_damage_power.md)/[回合免疫固伤](/powers/turn_immune_fixed_damage_power.md)/[长效体力](/powers/long_lasting_hp_power.md)/[圣谕形态](/powers/divine_form_power.md)（施加瞬间直接归零，最彻底）会直接免疫掉；更危险的是[坚毅](/powers/resolve_power.md)——被免疫的固伤会**原封不动转移给你方全体**，对有坚毅的 Boss 放固伤等于自杀。
