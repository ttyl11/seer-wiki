...
- **整局 7 片神羽的应急回血**：回合结束时若生命低于 60%，消耗 1 片神羽直接回满到 97%。7 片是整局共享的，用完就没了，得省着用。
- **Boss 战双buff：异常免疫 + PP 免耗**：Boss 战中免疫所有异常状态，且打牌不消耗 PP。相当于 Boss 战白嫖无限 PP + 不吃任何异常，Boss 战安全感拉满。
